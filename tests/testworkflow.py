...
if "makedatabook" in torun:
    ...
    if test == "sir":
        args = {"num_pops": 1, "num_transfers": 1, "data_start": 2000, "data_end": 2015, "data_dt": 1.0}
    elif test == "tb":
        args = {"num_pops": 12, "num_transfers": 3, "data_end": 2018}
    elif test in ["tb_simple", "tb_simple_dyn"]:
        args = {"num_pops": 1, "num_transfers": 0, "data_start": 2014, "data_end": 2018, "data_dt": 1.0}
    elif test == "diabetes":
        args = {"num_pops": 1, "num_transfers": 0, "data_start": 2014, "data_end": 2017, "data_dt": 1.0}
    elif test == "service":
        args = {"num_pops": 1, "num_transfers": 0, "data_start": 2014, "data_end": 2017, "data_dt": 1.0}
    elif test in ["udt", "usdt", "usdt_dyn", "dt"]:
        args = {"num_pops": 1, "num_transfers": 0, "data_start": 2016, "data_end": 2019, "data_dt": 1.0}
        ...
        args = {"num_pops": 4, "num_transfers": 0, "data_start": 2016, "data_end": 2019, "data_dt": 1.0}
